...
class ControllerExtensionModuleVQModManager extends Controller {
	...
	public function index() {
		...
		if($this->language->get('direction') == 'rtl') {
			$this->document->addStyle('view/stylesheet/vqmod_manager-rtl.css');
		} else {
		...
		// Action Buttons
		$data['action'] = $this->url->link('extension/module/vqmod_manager', 'user_token=' . $this->session->data['user_token'], true);
		$data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);
		$data['clear_log'] = $this->url->link('extension/module/vqmod_manager/clear_log', 'user_token=' . $this->session->data['user_token'], true);
		$data['clear_vqcache'] = $this->url->link('extension/module/vqmod_manager/clear_vqcache', 'user_token=' . $this->session->data['user_token'], true);
		$data['download_log'] = $this->url->link('extension/module/vqmod_manager/download_log', 'user_token=' . $this->session->data['user_token'], true);
		$data['download_scripts'] = $this->url->link('extension/module/vqmod_manager/download_vqmod_scripts', 'user_token=' . $this->session->data['user_token'], true);
		$data['download_vqcache'] = $this->url->link('extension/module/vqmod_manager/download_vqcache', 'user_token=' . $this->session->data['user_token'], true);
			...
			foreach ($vqmod_scripts as $vqmod_script) {
				...
				if ($extension == 'xml_') {
					$action[] = array(
						...
						'href' => $this->url->link('extension/module/vqmod_manager/vqmod_install', 'user_token=' . $this->session->data['user_token'] . '&vqmod=' . $file, true)
					);
				} else {
					$action[] = array(
						'text' => $this->language->get('text_uninstall'),
						'href' => $this->url->link('extension/module/vqmod_manager/vqmod_uninstall', 'user_token=' . $this->session->data['user_token'] . '&vqmod=' . $file, true)
					);
				}
				...
				$data['vqmods'][] = array(
					...
					'delete'      => $this->url->link('extension/module/vqmod_manager/vqmod_delete', 'user_token=' . $this->session->data['user_token'] . '&vqmod=' . basename($vqmod_script), true),
					'action'      => $action,
	...
	public function vqmod_install() {
		...
		$this->response->redirect($this->url->link('extension/module/vqmod_manager', 'user_token=' . $this->session->data['user_token'], true));
	}
