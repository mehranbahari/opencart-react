...
<link href="view/javascript/bootstrap/opencart/opencart-rtl.css" type="text/css" rel="stylesheet" />
<link href="view/javascript/font-awesome/css/font-awesome.min-rtl.css" type="text/css" rel="stylesheet" />
<link href="view/javascript/summernote/summernote-rtl.css" rel="stylesheet" />
<?php } else { ?>
...
<?php if ($direction == 'rtl') { ?>
<link href="view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min-rtl.css" type="text/css" rel="stylesheet" media="screen" />
  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="http://opencart.ir" target="_blank"><?php echo $text_homepage; ?></a></li>
        <li><a href="http://opencart.ir/دانشنامه-اپن-کارت-فارسی/all" target="_blank"><?php echo $text_documentation; ?></a></li>
        <li><a href="http://forum.opencart.ir" target="_blank"><?php echo $text_support; ?></a></li>		
        <?php if ($direction == 'rtl') { ?>		
        <li><a href="http://asanwebhost.com" target="_blank">هاستینگ اپن کارت</a></li>
        <li><a href="http://temp4u.net" target="_blank">قالب های تجاری</a></li>	
        <li><a href="http://shop.opencart.ir" target="_blank">افزونه های تجاری</a></li>			
        <?php } else { ?>
        <li><a href="http://asanwebhost.com" target="_blank">OpenCart Hosting</a></li>
        <li><a href="http://temp4u.net" target="_blank">Commercial Themes</a></li>	
        <li><a href="http://shop.opencart.ir" target="_blank">Commercial Extensions</a></li>			
        <?php } ?>		
      </ul>
    </li>
