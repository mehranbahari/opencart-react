  ...
  <div class="row">
    <div class="col-sm-9">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        <p style="direction:rtl;"><?php echo $text_install_php; ?></p>
        <fieldset>
          <table class="table">
            <thead>
              <tr>
        ...
        <p style="direction:rtl;"><?php echo $text_install_extension; ?></p>
        <fieldset>
          <table class="table">
            <thead>
              <tr>
        ...
        <p style="direction:rtl;"><?php echo $text_install_file; ?></p>
        <fieldset>
          <table class="table">
            <thead>
              <tr>
        ...
        <p style="direction:rtl;"><?php echo $text_install_directory; ?></p>
        <fieldset>
          <table class="table">
            <thead>
              <tr>
    ...
    <div class="col-sm-3">
      <ul class="list-group">
        ...
        <li class="list-group-item" style="direction:rtl; text-align:right;"><b><?php echo $text_installation; ?></b></li>
        <li class="list-group-item" style="direction:rtl; text-align:right;"><?php echo $text_configuration; ?></li>
