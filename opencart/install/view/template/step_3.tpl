  ...
  <div class="row">
    <div class="col-sm-9">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <p style="direction:rtl;"><?php echo $text_db_connection; ?></p>
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="text-danger" style="direction:rtl;"><?php echo $error_db_hostname; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="text-danger" style="direction:rtl;"><?php echo $error_db_username; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="text-danger" style="direction:rtl;"><?php echo $error_db_database; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div class="text-danger" style="direction:rtl;"><?php echo $error_db_prefix; ?></div>
              <?php } ?>           
           </div>
          </div>
        </fieldset>
        <p style="direction:rtl;"><?php echo $text_db_administration; ?></p>
        <fieldset>
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="text-danger" style="direction:rtl;"><?php echo $error_username; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <div class="text-danger" style="direction:rtl;"><?php echo $error_password; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <?php if ($error_email) { ?>
              <div class="text-danger" style="direction:rtl;"><?php echo $error_email; ?></div>
              <?php } ?>
            </div>
          </div>
        </fieldset>
    ...
    <div class="col-sm-3">
      <ul class="list-group">
        <li class="list-group-item" style="direction:rtl; text-align:right;"><?php echo $text_license; ?></li>
        <li class="list-group-item" style="direction:rtl; text-align:right;"><?php echo $text_installation; ?></li>
        <li class="list-group-item" style="direction:rtl; text-align:right;"><b><?php echo $text_configuration; ?></b></li>
        <li class="list-group-item" style="direction:rtl; text-align:right;"><?php echo $text_finished; ?></li>
      </ul>
    </div>
  </div>
</div>
