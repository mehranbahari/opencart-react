...
function aasort(&$array, $key) {
	...
	reset($array);
	foreach ($array as $rowKey => $rowValue) { $sorter[$rowKey] = $rowValue[$key]; }
	
	asort($sorter);
	foreach ($sorter as $rowKey => $rowValue) { $return[] = $array[$rowKey]; }
	
	$array = ($return);
}

function call_empty($var) {
	return $var; // Return Function Arg
}
