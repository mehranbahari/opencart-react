<form class="form-horizontal">
  ...
  <div id="payment-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['country']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['city']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?></option>
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['country']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['city']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?></option>
      <?php } ?>
      <?php } ?>
    </select>
  </div>
